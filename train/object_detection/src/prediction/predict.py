...
def predict(cfg):
    ...
    # TFlite model
        ...
        input_details = interpreter_quant.get_input_details()[0] # 返回一个dict因为只有一个输入层(len=8是指有8个key)
        outputs_details = interpreter_quant.get_output_details() # 返回一个list[dict * 3] 因为有三个输出层
